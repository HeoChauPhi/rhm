...
add_action( 'after_setup_theme', 'rhm_setup' );
function rhm_setup() {
...
add_action( 'init', 'rhm_remove_default_field' );
function rhm_remove_default_field() {
  remove_post_type_support( 'page', 'thumbnail' );
}

// Unset URL from comment form
add_filter( 'comment_form_fields', 'rhm_move_comment_form_below' );
function rhm_move_comment_form_below( $fields ) {
...
add_action( 'pre_get_posts',  'rhm_set_posts_per_page'  );
function rhm_set_posts_per_page( $query ) {
  global $wp_the_query;
...
function rhm_get_widget_id($widget_instance) {
...
add_action('in_widget_form', 'rhm_get_widget_id');

// Sidebar widget arena
add_action( 'widgets_init', 'rhm_create_sidebar_Widget' );
function rhm_create_sidebar_Widget() {
...
// Header widget arena
add_action( 'widgets_init', 'rhm_create_header_Widget' );
function rhm_create_header_Widget() {
...
// Footer widget arena
add_action( 'widgets_init', 'rhm_create_footer_Widget' );
function rhm_create_footer_Widget() {
