...
// Admin settings.
if(is_admin()) {
  $settings = new RHMSettingsPage();
}

// Add admin script
function rhm_options_admin_scripts() {
...
add_action('admin_init', 'rhm_options_admin_scripts');

// Add admin script
function rhm_options_admin_styles() {
...
add_action('admin_init', 'rhm_options_admin_styles');
